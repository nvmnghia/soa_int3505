...
\begin{itemize}
    ...
    \item Tài nguyên dùng chung: Tài nguyên của nhà cung cấp đưọc gộp lại và cho
        ...
        vị trí ở mức cao hơn (quốc gia, địa điểm, trung tâm dữ liệu, ...).
    ...
    \item Dịch vụ được điều tiết: Hệ thống tự động điều khiển và tối ưu việc sử
        ...
        thuật như số CPU, IOPS, ... Thông tin sử dụng có thể đưọc theo dõi, báo
        cáo cho cả người dùng và nhà cung cấp dịch vụ.
\end{itemize}
