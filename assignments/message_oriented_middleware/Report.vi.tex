...
\begin{itemize}
    ...
    và giao mỗi partition cho một consumer. Với mỗi consumer, thứ tự thông điệp
    được đảm bảo, do đó có thể tăng tốc xử lí theo kiểu fan-out. Tuy nhiên, thứ
    tự thông điệp giữa các consumer không được đảm bảo, do đó ứng dụng cũng phải
